...
import { Form,Input, Row, Col, Button,Select,DatePicker,Switch } from 'antd'
            ...
            <FormItem label={'所属分区'} wrapperCol={{span:5}} labelCol={{ span: 3 }}>
                    {
                        getFieldDecorator(
                            'schoolAreaId',
                            {initialValue:props['schoolAreaId']||'',rules:[{required:true,message:'必填'}] }
                        )(
                            <Select
                                style={{ width: 150 }}
            ...
            <FormItem label={'学校Banner'} wrapperCol={{span:20}} labelCol={{ span: 3 }}>
                ...
                <Uploader 
                    updateFileList={images=>{
                        Model.change('collegeSchoolinfo2','images',images)
            ...
            <FormItem label={'是否上架'} wrapperCol={{span:3}} labelCol={{ span: 3 }}>
                    {
                        getFieldDecorator(
                           ...
                           <Switch checked={props['putOn']||false}
                            onChange={(checked)=>Model.change('collegeSchoolinfo2','putOn',checked)}
...
const antdComps =Model.connect(['collegeSchoolarea','collegeSchoolinfo2'])(antdComp)
