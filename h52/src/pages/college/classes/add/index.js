...
function CollegeClasses(props){
function submit(value){
        console.log(value)
        const body = {...value}
        props.run(function*({fetch}){
              const res = yield fetch(`school-classes`,{method:'post',body:value})           
...
const CollegeClasses1=Model.connect('collegeClasses')(CollegeClasses)
export default Model.connect('collegeClasses1')(CollegeClasses1)