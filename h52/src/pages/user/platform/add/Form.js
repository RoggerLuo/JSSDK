...
const FormComp = ({ form,roles,list,tagsList,listarea,submit,...props }) => {
    ...
    const getroles=(value,option)=>{
        ...
        Model.change('userPlatformAdd','roleIds',value)    
    }
    // const clickClean=()=>{
    ...
    return(
        <Form>
            ...
            <FormItem label={'关联课程标签'} wrapperCol={{span:6}} labelCol={{ span: 2 }}>
                    {
                        getFieldDecorator(
                            'courseLabelIds',
            ...
            <FormItem label={'所属分区或学校'} wrapperCol={{span:6}} labelCol={{ span: 2 }}>
                  {   
                    ...
                    getFieldDecorator(
                        ...
                        >

                            {
                                ...
                                return <Option value={el.schoolAreaId} key={index} >{el.schoolArea}</Option>}
                               })
...
// 
                ...
                //                  {
                            ...
                            //     list.map((el,index)=>{
                            //           
                            //     if(props.roleIds=="033f7a34167a49d6b320ba6fd96d8d50"||props.roleIds=="66561692571343aeb37206973a7b75ab")  {                                    
                            //          return <Option value={el.schoolInfoId} key={index} >{el.schoolName}</Option>
                            //         }
                            //      }) 
                            ...
                            // }{
                            //     listarea.map((el,index)=>{
                            //     if(props.roleIds=="1a33ec8b7ef54782baee15d1470cc56d"||props.roleIds=="5188e00a97ec41ffa238ed214a983f16"||props.roleIds=="f297ec22cb7d40ccbf85094a7be5ec96"){
                            //     return <Option value={el.schoolAreaId} key={index} >{el.schoolArea}</Option>}
                            //    })
