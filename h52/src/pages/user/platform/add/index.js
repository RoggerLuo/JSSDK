...
function submit(value){
        ...
        props.run(function*({fetch}){
            const res = yield fetch(`user-platformteacher`,{method:'post',body:value})           
...
const UserPlatforms=Model.connect('userPlatform')(UserPlatform)
export default Model.connect('userPlatform1')(UserPlatforms)
