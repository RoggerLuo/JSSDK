...
function openView({refundApplicationId}){
    redirect(`/home/deal/application/view/${refundApplicationId}`)
}


function DealApplication(props){
...
export default Model.connect('dealApplication2')(DealApplication)
