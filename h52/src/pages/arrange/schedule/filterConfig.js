    ...
    return (
        <Select
            ...
            onDropdownVisibleChange={(open)=>{
                Model.dispatch({type:'commonData/getAreas',cityId:Model.get('schedule').query.cityId})
            }}
        >
            {
                List.map((obj,index) =>{
...
const MapSelectCities = Model.connect(['commonData','schedule'])(MapSelectCity)
const MapSelectProvinces = Model.connect(['commonData','schedule'])(MapSelectProvince)

const Areas = Model.connect(['commonData','schedule'])(SelectSchoolArea)
